...
- **Presence indicator**: a dot before each destination name — ● green when you have facilities built on the body (probes excluded, moons count toward their parent, same rule as My Bases), ● yellow when a scheduled or in-flight mission departs from or arrives there, ○ grey otherwise. Green takes precedence. Updates on every refresh.
